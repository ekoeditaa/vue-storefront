<template>
  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckout }">
    <newsletter class="flex" v-if="!isCheckout"/>
    <div
      class="footer-links flex bg-cl-tertiary"
      v-if="!isCheckout"
    >
      <div class="container px15 pt30 pb60">
        <div class="row center-xs between-md">
          <div
            class="col-lg-7 col-md-8 col-xs-12 no-mobile"
          >
            <div class="flex start-md between-md between-xs">
              <div class="start-md">
                <h3 class="cl-tertiary fs-big">
                  {{ $t('About us') }}
                </h3>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/inside-the-maccalan')" exact>
                    {{ $t('Inside the Maccalan') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/the-six-illars')" exact>
                    {{ $t("The six pillars") }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/distillary')" exact>
                    {{ $t('Distillary') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/careers')" exact>
                    {{ $t('Careers') }}
                  </router-link>
                </div>
              </div>
              <div class="start-md">
                ...
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/order-tracking')" exact>
                    {{ $t('Track my order') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/my-account')" exact>
                    {{ $t('My account') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/delivery')" exact>
                    {{ $t('Delivery') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/returns')" exact>
                    {{ $t('Return policy') }}
                  </router-link>
                </div>
              </div>
              <div class="start-md">
                ...
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/customer-service')" exact>
                    {{ $t('Customer service') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/size-guide')" exact>
                    {{ $t('Size guide') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/contact')" exact>
                    {{ $t('Contact us') }}
                  </router-link>
                </div>
              </div>
              <div class="start-md">
                ...
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/shipping')" exact>
                    {{ $t('About us') }}
                  </router-link>
                </div>
                <div class="mt15">
                  <router-link class="cl-tertiary" :to="localizedRoute('/contact-us')" exact>
                    {{ $t('Store locator') }}
                  </router-link>
                </div>
              </div>
          ...
          <div class="col-lg-5 col-md-4 col-xs-12 social mt40">
            <div class="row end-xl center-xs">
              <a
                class="social-icon mx10 brdr-circle no-underline"
                href="https://www.facebook.com/themacallan"
                :aria-label="$t('Go to Facebook')"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="facebook icon" width="40" height="40" viewBox="0 0 40 40" fill="#B29B70">
              ...
              <a
                class="social-icon mx10 brdr-circle no-underline"
                href="https://www.instagram.com/The_Macallan/"
                :aria-label="$t('Go to Instagram')"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="instagram icon" width="40" height="40" viewBox="0 0 40 40" fill="#B29B70">
              ...
              <a
                class="social-icon mx10 brdr-circle no-underline"
                href="https://pl.pinterest.com/themacallan/"
                :aria-label="$t('Go to Pinterest')"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="pinterest icon" width="40" height="40" viewBox="0 0 40 40" fill="#B29B70">
              ...
              <a
                class="social-icon mx10 brdr-circle no-underline"
                href="https://www.youtube.com/channel/UCFgN7m_XSuPA2R__ZOxy8ew"
                :aria-label="$t('Go to Youtube')"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="youtube icon" width="40" height="40" viewBox="0 0 40 40" fill="#B29B70">
    ...
    <div class="container px15">
      <div class="row middle-xs bottom-links">
        <div class="col-xs-5 col-sm-3 cl-silver">
          <language-switcher v-if="multistoreEnabled" />
        </div>
        <div class="col-xs col-sm-9 end-xs">
          <ul class="pl0 py13 links">
            <li class="inline-flex">
              <router-link
                class="cl-silver mr20 underline"
                to="/legal"
                exact
              >
                {{ $t('Legal notice') }}
